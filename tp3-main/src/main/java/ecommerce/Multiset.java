...
public class Multiset<T> extends AbstractCollection<T> implements Collection<T> {
     ...
     */
    @Override
    public boolean add(T t) { // User story 1
    ...
    public boolean remove(Object o) { // User story 2
     ...
     * @param arity le nouveau nombre d'occurrences de l'objets dans le multiensemble
